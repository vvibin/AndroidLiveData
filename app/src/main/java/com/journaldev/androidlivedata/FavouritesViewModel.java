...
public class FavouritesViewModel extends AndroidViewModel {
    ...
    private void loadFavs() {
        Log.d("liveex","loadFavs tid " + Thread.currentThread().getId());
    ...
    public void removeFav(long id) {
     ...
     class loaderExecutor implements Executor{

            public synchronized void execute (final Runnable r)
            {
                Log.d("liveex","loadExecutor tid " + Thread.currentThread().getId());
                new Thread(r).start();
